...
dv01_fi_df = uc.read_latest(dataset_cfg.inputs.dv01_fi, dataset_cfg.watermark_col)
dv01_derivatives_df = uc.read_latest(dataset_cfg.inputs.dv01_derivatives, dataset_cfg.watermark_col)
dv01_liab_post_hp_df = uc.read_latest(dataset_cfg.inputs.dv01_liab_post_hp, dataset_cfg.watermark_col)
fx_rates_df = uc.read_latest(dataset_cfg.inputs.fx_rates, dataset_cfg.watermark_col)
heirarchy_mapping_df = uc.read_latest(dataset_cfg.inputs.heirarchy_mapping_latest, dataset_cfg.watermark_col)
